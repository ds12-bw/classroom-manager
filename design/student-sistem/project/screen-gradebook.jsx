                      ...
                      <tr key={s.id}>
                        ...
                        <td>
                          <button className="row" style={{gap:10, textAlign:"left"}}
                            ...
                            <Avatar color={s.avatar} label={s.nick.slice(0,1)} size={28}/>
                            <div>
                              <div className="bold text-sm" style={{whiteSpace:"nowrap"}}>{s.name} {s.surname} <span className="muted" style={{fontWeight:400}}>({s.nick})</span></div>
